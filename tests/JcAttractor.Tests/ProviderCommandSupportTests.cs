...
public class ProviderCommandSupportTests
{
    ...
    public void ResolveRepositoryRoot_FindsRootFromNestedDirectory()
    {
        ...
        var nested = Path.Combine(repoRoot, "src", "JcAttractor.UnifiedLlm", "Providers");
        Directory.CreateDirectory(Path.Combine(repoRoot, "runner"));
        Directory.CreateDirectory(Path.Combine(repoRoot, "src", "JcAttractor.UnifiedLlm"));
        Directory.CreateDirectory(nested);
        File.WriteAllText(Path.Combine(repoRoot, "runner", "Runner.csproj"), "<Project />");
        File.WriteAllText(Path.Combine(repoRoot, "src", "JcAttractor.UnifiedLlm", "ModelCatalog.cs"), "public static class ModelCatalog {}");
